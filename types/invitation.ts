...
export interface InvitationData {
  ...
  rsvp: { enabled: boolean; endpoint?: string; googleSheetId?: string; minGuests: number; maxGuests: number; eyebrow: LocalizedText; heading: LocalizedText; deadline: LocalizedText; labels: { guestName: LocalizedText; guestNamePlaceholder: LocalizedText; attendance: LocalizedText; guestCount: LocalizedText; guestLimit: LocalizedText; submit: LocalizedText; submitting: LocalizedText; success: LocalizedText; successDetail: LocalizedText; error: LocalizedText; decreaseGuests: LocalizedText; increaseGuests: LocalizedText }; attendanceOptions: { yes: LocalizedText; no: LocalizedText } };
