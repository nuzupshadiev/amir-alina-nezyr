...
const metadataTitle = `${names} — ${t(invitation.metadata.titleSuffix, language)}`;
const metadataDescription = t(invitation.metadata.description, language);
export const metadata: Metadata = { ...createSocialMetadata({ title: metadataTitle, description: metadataDescription, language }) };
